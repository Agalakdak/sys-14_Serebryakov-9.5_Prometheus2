# Домашнее задание к занятию "9.5. Prometheus ч.2" - "Серебряков Руслан"
...
---
В этом задании я получил ошибку (графана не хотела искать шаблон для метрик). По этому я приложил скриншот ошибки.
![](./img/exercise4.png)
---
---
